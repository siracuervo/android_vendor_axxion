...
PRODUCT_COPY_FILES += \
    vendor/axxion/prebuilt/common/etc/init.d/50selinuxrelabel:system/etc/init.d/50selinuxrelabel
...
AxxionKat_DISPLAY_VERSION := $(AXXION_VERSION)
...
ifneq ($(AXXION_DEFAULT_DEV_CERTIFICATE),build/target/product/security/testkey)
 ...
 ifneq ($(AXXION_EXTRAVERSION),)
    ...
    AxxionKat_DISPLAY_VERSION=$(AXXION_VERSION_MAJOR).$(AXXION_VERSION_MINOR)$(TARGET_VENDOR_RELEASE_BUILD_ID)
endif
endif
endif
