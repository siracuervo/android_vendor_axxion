...
ALARM_PATH := vendor/lego/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/lego/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/lego/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/lego/prebuilt/common/media/audio/ui
