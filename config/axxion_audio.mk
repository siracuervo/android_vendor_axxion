...
ALARM_PATH := vendor/axxion/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/axxion/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/axxion/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/axxion/prebuilt/common/media/audio/ui
